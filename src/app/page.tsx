export default function Home() {
  return (
    <main className="min-h-screen bg-[#e0f0e9] flex items-center justify-center px-4 py-20">
      ...
      <div className="relative bg-white max-w-3xl w-full p-10 rounded-2xl border-[2px] border-yellow-500 min-h-[900px]">
        
        {/* ZH Button (jetzt 72px hoch, goldener Rand) */}
        <a
        ...
        >
          <img
            src="/ZH_route.png"
            alt="ZH"
            className="h-[72px] w-auto border-[2px] border-[#74190f] rounded"
          />
        </a>

        {/* Startpunkt: exakt unter dem Logo */}
        <div className="mt-[calc(9mm+72px)]">
          {/* Header */}
